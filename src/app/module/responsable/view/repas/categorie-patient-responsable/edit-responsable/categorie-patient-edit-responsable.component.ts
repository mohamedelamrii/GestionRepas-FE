...
@Component({
  selector: 'app-categorie-patient-edit-responsable',
  templateUrl: './categorie-patient-edit-responsable.component.html'
})
export class CategoriePatientEditResponsableComponent implements OnInit {
