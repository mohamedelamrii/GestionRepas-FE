...
@Component({
  selector: 'app-categorie-patient-view-responsable',
  templateUrl: './categorie-patient-view-responsable.component.html'
})
export class CategoriePatientViewResponsableComponent implements OnInit {
