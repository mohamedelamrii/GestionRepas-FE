...
@Component({
  selector: 'app-categorie-patient-list-responsable',
  templateUrl: './categorie-patient-list-responsable.component.html'
})
export class CategoriePatientListResponsableComponent implements OnInit {
