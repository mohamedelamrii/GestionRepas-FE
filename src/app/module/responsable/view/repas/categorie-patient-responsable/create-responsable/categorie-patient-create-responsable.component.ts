...
@Component({
  selector: 'app-categorie-patient-create-responsable',
  templateUrl: './categorie-patient-create-responsable.component.html'
})
export class CategoriePatientCreateResponsableComponent implements OnInit {
