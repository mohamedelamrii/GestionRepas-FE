...
@Component({
  selector: 'app-planning-view-responsable',
  templateUrl: './planning-view-responsable.component.html'
})
export class PlanningViewResponsableComponent implements OnInit {
