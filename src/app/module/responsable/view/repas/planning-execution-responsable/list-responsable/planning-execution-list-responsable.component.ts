...
@Component({
  selector: 'app-planning-execution-list-responsable',
  templateUrl: './planning-execution-list-responsable.component.html'
})
export class PlanningExecutionListResponsableComponent implements OnInit {
