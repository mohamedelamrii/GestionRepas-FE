...
@Component({
  selector: 'app-patient-list-responsable',
  templateUrl: './patient-list-responsable.component.html'
})
export class PatientListResponsableComponent implements OnInit {
