...
@Component({
  selector: 'app-patient-edit-responsable',
  templateUrl: './patient-edit-responsable.component.html'
})
export class PatientEditResponsableComponent implements OnInit {
