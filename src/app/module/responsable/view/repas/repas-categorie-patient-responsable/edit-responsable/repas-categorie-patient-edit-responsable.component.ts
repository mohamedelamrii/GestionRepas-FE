...
@Component({
  selector: 'app-repas-categorie-patient-edit-responsable',
  templateUrl: './repas-categorie-patient-edit-responsable.component.html'
})
export class RepasCategoriePatientEditResponsableComponent implements OnInit {
