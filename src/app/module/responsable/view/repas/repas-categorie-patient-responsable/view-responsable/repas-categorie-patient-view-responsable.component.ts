...
@Component({
  selector: 'app-repas-categorie-patient-view-responsable',
  templateUrl: './repas-categorie-patient-view-responsable.component.html'
})
export class RepasCategoriePatientViewResponsableComponent implements OnInit {
