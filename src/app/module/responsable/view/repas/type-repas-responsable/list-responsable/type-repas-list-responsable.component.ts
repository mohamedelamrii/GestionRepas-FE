...
@Component({
  selector: 'app-type-repas-list-responsable',
  templateUrl: './type-repas-list-responsable.component.html'
})
export class TypeRepasListResponsableComponent implements OnInit {
