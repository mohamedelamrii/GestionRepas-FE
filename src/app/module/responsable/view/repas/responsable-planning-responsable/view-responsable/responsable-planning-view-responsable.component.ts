...
@Component({
  selector: 'app-responsable-planning-view-responsable',
  templateUrl: './responsable-planning-view-responsable.component.html'
})
export class ResponsablePlanningViewResponsableComponent implements OnInit {
