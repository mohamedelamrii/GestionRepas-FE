...
@Component({
  selector: 'app-responsable-planning-list-responsable',
  templateUrl: './responsable-planning-list-responsable.component.html'
})
export class ResponsablePlanningListResponsableComponent implements OnInit {
