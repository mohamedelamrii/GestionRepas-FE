...
@Component({
  selector: 'app-planning-repas-edit-responsable',
  templateUrl: './planning-repas-edit-responsable.component.html'
})
export class PlanningRepasEditResponsableComponent implements OnInit {
   ...
   _validPlanningRepasQuantite = true;
    ...
    constructor(private datePipe: DatePipe, private planningRepasService: PlanningRepasService, private stringUtilService: StringUtilService,
    ...
    public editWithShowOption(showList: boolean){
         this.planningRepasService.edit().subscribe(planningRepas=>{
         const myIndex = this.planningRepass.findIndex(e => e.id === this.selectedPlanningRepas.id);
         this.planningRepass[myIndex] = planningRepas;
         this.editPlanningRepasDialog = false;
