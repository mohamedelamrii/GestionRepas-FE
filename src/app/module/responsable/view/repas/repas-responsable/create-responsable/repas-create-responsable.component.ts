...
@Component({
  selector: 'app-repas-create-responsable',
  templateUrl: './repas-create-responsable.component.html'
})
export class RepasCreateResponsableComponent implements OnInit {
     ...
     this.repasService.save().subscribe(repas=>{
        if(repas != null){
           ...
           this.selectedRepas = new RepasDto();
            ...
            this.messageService.add({severity: 'error', summary: 'Erreurs',detail: 'Repas existe déjà' });
        }
