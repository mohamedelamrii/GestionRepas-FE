...
@Component({
  selector: 'app-repas-categorie-patient-list-admin',
  templateUrl: './repas-categorie-patient-list-admin.component.html'
})
export class RepasCategoriePatientListAdminComponent implements OnInit {
