...
@Component({
  selector: 'app-planning-execution-view-admin',
  templateUrl: './planning-execution-view-admin.component.html'
})
export class PlanningExecutionViewAdminComponent implements OnInit {
